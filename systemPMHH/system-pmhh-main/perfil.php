                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body" style="background: rgb(97,97,97);
background: radial-gradient(circle, rgba(97,97,97,1) 34%, rgba(0,0,0,1) 85%);">
...
<img style="-webkit-filter: drop-shadow(0 1px 0 #FFF) drop-shadow(0 -1px 0 #FFF) drop-shadow(1px 0 0 #FFF) drop-shadow(-1px 0 0 #FFF);" src="https://www.habbo.com.br/habbo-imaging/avatarimage?user=<?php echo $usr_nome ?>&action=std&direction=4&head_direction=3&gesture=std&size=b" />
                                        ...
                                        <div class="mx-auto d-block">
                                            <img class="rounded mx-auto d-block" style="border: 1px solid black; -webkit-filter: drop-shadow(0 1px 0 #FFF) drop-shadow(0 -1px 0 #FFF) drop-shadow(1px 0 0 #FFF) drop-shadow(-1px 0 0 #FFF);" src="https://www.habbo.com.br/habbo-imaging/avatarimage?user=<?php echo $usr_nome ?>&action=std&direction=3&head_direction=3&gesture=std&size=l&headonly=1" alt="Card image cap"> <img style="box-shadow: 1px 3px 10px white; right: 15px; top: 20%; position: absolute; width: 10%;" src="<?php echo $imagem_site ?>">
                                        ...
                                        <div class="card-text text-sm-center">
                                            ...
                                            <a href="#" style="color: white;">
                                                <i class="fa fa-paperclip"></i> <?php $select_relatorios = mysqli_query($conn, "SELECT * FROM relatorios WHERE usr_habbo = '{$usr_nome}'"); echo $count_rel = mysqli_num_rows($select_relatorios); ?> relatórios enviados.
                                            </a>
                                            <a href="#" style="color: white;">
