...
<form action='./includes/ajax_verfakes_nome.php' class='buscar' method='get' target='pesquisado'>
<h3>Lembrete: A busca por IP é mais precisa.</h3>
<div class='texto-busca'>Digite o nome de usuário do militar para realizar a pesquisa: </div>
<input class='buscar-barra' id='main2' name='consulta' onkeyup='this.value = Trim( this.value )' placeholder='Insira o nome do militar...' required='' type='text' value=''/>
