...
<head>
    ...
    <!-- Title Page-->
    <title><?php echo $titulo_site ?> - Registro</title>
                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="#">
                            <h3>System PMHH - Registro <img src="<?php echo $imagem_site ?>" /></h3> 
                            </a>
                        </div>
                        <div class="login-form">
                            <form action="kernel/register.php" method="post">
                        ...
                        ?>
                                <div class="form-group">
                                    ...
                                    <small>Coloque o código acima em sua missão. Espere cerca de 10 segundos e registre-se.</small>
                                </div>
